...
# -------------------------
#  ADVANCED BIODIVERSITY SIMULATION WITH ROLES AND IQ TEST
# -------------------------

class BioAgent:
    """
    Represents an agent with unique biological traits, the ability to learn pseudo surgery, and a role (user/administrator).
    """
    ...
    def act(self):
        return f"{self.species} ({self.color}) {self.behavior} with speed {self.speed}, vision {self.vision}, surgery skill {self.surgery_skill:.2f}, role {self.role}, IQ {self.iq}."
...
if __name__ == "__main__":
    ...
    print("Advanced Biodiversity Simulation: Roles and IQ Test\n")
